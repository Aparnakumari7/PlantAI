...
const JWT_SECRET = process.env.JWT_SECRET || 'super-secret-key'; // Use environment variable in production
...
app.post('/api/auth/register', async (req, res) => {
  ...
  try {
    ...
    const isAdmin = 0; // Admin rights must be granted manually via database
